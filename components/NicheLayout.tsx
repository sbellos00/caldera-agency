      ...
      <main>
        ...
        <section className="relative bg-[var(--cream)] overflow-hidden pt-36 md:pt-44 pb-14 md:pb-20">
          ...
          <div className="relative z-10 max-w-screen-lg mx-auto px-8 md:px-16">
            <p className="text-[var(--primary-blue)] text-sm font-medium tracking-widest uppercase mb-5">{c.eyebrow}</p>
            <h1 className="text-[clamp(2.2rem,4.6vw,4.2rem)] font-light tracking-tight leading-[1.0] mb-8 text-[var(--black)]">
              {c.h1Lead} <span className="font-serif italic font-normal text-[var(--primary-blue)]">{c.h1Accent}</span>
            </h1>
            <p className="text-lg md:text-xl leading-relaxed text-[var(--gray-dark)] max-w-3xl mb-8">{c.answer}</p>
            <Link
              href="/contact"
        ...
        <section className="py-14 md:py-20 px-8 md:px-16 bg-white">
          <div className="max-w-screen-lg mx-auto">
            <h2 className="text-[clamp(24px,3.2vw,40px)] font-light tracking-tight leading-tight mb-5 text-[var(--black)]">{c.whyTitle}</h2>
            <div className="text-[16px] md:text-[17px] leading-relaxed text-[var(--gray-dark)] max-w-3xl mb-10">{c.whyIntro}</div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {c.painPoints.map((p) => (
                <div key={p.h} className="bg-[var(--cream)] rounded-2xl p-7">
        ...
        <section className="py-14 md:py-20 px-8 md:px-16 bg-[var(--cream)]">
          <div className="max-w-screen-lg mx-auto">
            <h2 className="text-[clamp(24px,3.2vw,40px)] font-light tracking-tight leading-tight mb-5 text-[var(--black)]">{c.buildTitle}</h2>
            <div className="text-[16px] md:text-[17px] leading-relaxed text-[var(--gray-dark)] max-w-3xl mb-8">{c.buildIntro}</div>
            <ul className="space-y-4 max-w-3xl">
              {c.buildPoints.map((p) => (
                <li key={p.h} className="flex items-start gap-3">
        ...
        <section className="py-14 md:py-20 px-8 md:px-16 bg-white">
          <div className="max-w-screen-lg mx-auto">
            <div className="text-[16px] md:text-[17px] leading-relaxed text-[var(--gray-dark)] max-w-3xl mb-8">{c.proofIntro}</div>
            <figure className="bg-[var(--cream)] rounded-2xl p-7 md:p-10">
        ...
        <section className="py-14 md:py-20 px-8 md:px-16 bg-[var(--cream)]">
          <div className="max-w-screen-lg mx-auto">
            <h2 className="text-[clamp(24px,3.2vw,40px)] font-light tracking-tight leading-tight mb-10 text-[var(--black)]">Frequently asked questions</h2>
