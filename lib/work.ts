...
// Confirmed, live case studies. Each entry pairs a Cloudinary screenshot with the
// live site. Summaries are intentionally left empty for now — fill them in per
// client. Where the consultant's name could not be confirmed, `name`/`role` are
// blank and the card falls back to showing the domain as its title.
