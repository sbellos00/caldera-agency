...
const content: NicheContent = {
  ...
  answer: (
    <>
      ...
      first call. The best one states the kind of company you steer, the financial outcomes you have delivered, and the
  ...
  whyIntro: (
    <>
      ...
      CFO is not browsing; they are de-risking a decision that affects payroll and runway. If your online presence
      doesn&rsquo;t immediately read as senior, precise, and proven, you lose to someone who looks the part — often
  ...
  buildIntro: (
    <>
      ...
      financial seniority and convert a referral into a conversation. Everything is custom and fully owned by you.
    </>
  ),
  buildPoints: [
    { h: 'Positioning that separates you from accounting.', b: 'Language that frames you as a strategic finance partner — runway, fundraising, unit economics, board-ready reporting — not back-office support.' },
    ...
    { h: 'A clear engagement menu.', b: 'The specific ways you work — interim CFO, fundraising support, financial systems — so a buyer self-qualifies before the call.' },
    { h: 'A credibility-first design.', b: 'Restrained, precise, and senior — the visual equivalent of a clean balance sheet.' },
  ],
  proofIntro: (
    <>
      We have done exactly this for a fractional CFO. Mark Piazza came to us to formally launch his practice; we
