...
import HomeClientV5 from "@/components/HomeClientV5"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Caldera Agency - Professional Websites for Consultants" }],
  },
  twitter: {
